    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('supervisor', 'Επόπτης'), ('teacher', 'Εκπαιδευτικός')], default='teacher', max_length=20, verbose_name='Ρόλος')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('action', models.CharField(choices=[('login', 'Σύνδεση'), ('logout', 'Αποσύνδεση'), ('password_change', 'Αλλαγή Κωδικού'), ('password_reset', 'Επαναφορά Κωδικού'), ('profile_update', 'Ενημέρωση Προφίλ'), ('account_created', 'Δημιουργία Λογαριασμού'), ('account_deactivated', 'Απενεργοποίηση Λογαριασμού'), ('account_activated', 'Ενεργοποίηση Λογαριασμού')], max_length=50)),
            ...
            options={
                'verbose_name': 'Δραστηριότητα Χρήστη',
                'verbose_name_plural': 'Δραστηριότητες Χρηστών',
                'ordering': ['-timestamp'],
            },
        ),
    ]
